	...
	function understrap_pagination( $args = array(), $class = 'pagination' ) {
		...
		$args = wp_parse_args(
			...
			array(
				'mid_size'           => 2,
				'prev_next'          => true,
				'prev_text'          => __( '<i class="fa fa-long-arrow-left" aria-hidden="true"></i>', 'understrap' ),
				'next_text'          => __( '<i class="fa fa-long-arrow-right" aria-hidden="true"></i>', 'understrap' ),
				'type'               => 'array',
		...
		<nav aria-labelledby="posts-nav-label" class="mt-5 mb-5 mb-lg-0">
			...
			<ul class="<?php echo esc_attr( $class ); ?> justify-content-center">
				...
				foreach ( $links as $key => $link ) {
					...
					<li class="page-item <?php echo strpos( $link, 'current' ) ? 'active' : ''; ?>">
						<?php echo str_replace( 'page-numbers', 'page-link h-100', $link ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
					</li>
					<?php
				}
				?>
